...
public enum ActionList implements Constants {
    ...
    DRAGON_BREATH("Dragon Breath", NativeKeyEvent.VC_1, false, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/dragon_breath.png", ActionStyle.MAGIC),
    SONIC_WAVE("Sonic Wave", NativeKeyEvent.VC_2, false, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/sonic_wave.png", ActionStyle.MAGIC),
    WRACK("Wrack", NativeKeyEvent.VC_3, false, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/wrack.png", ActionStyle.MAGIC),
    IMPACT("Impact", NativeKeyEvent.VC_4, false, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/impact.png", ActionStyle.MAGIC),
    CHAIN("Chain", NativeKeyEvent.VC_1, true, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/chain.png", ActionStyle.MAGIC),
    TUSKA_MAGE("Tuska's Wrath", NativeKeyEvent.VC_2, true, false, false,
            ActionTier.BASIC_ABILITY, HITPOINTS_PATH+"/tuska_wrath.png", ActionStyle.MAGIC),
    TSUNAMI("Tsunami", NativeKeyEvent.VC_3, true, false, false,
            ActionTier.ULTIMATE_ABILITY, MAGIC_PATH+"/tsunami.png", ActionStyle.MAGIC),
    DEEP_IMPACT("Deep Impact", NativeKeyEvent.VC_4, true, false, false,
            ActionTier.TRESHOLD_ABILITY, MAGIC_PATH+"/deep_impact.png", ActionStyle.MAGIC),
    WILD_MAGIC("Wild Magic", NativeKeyEvent.VC_Q, true, false, false,
            ActionTier.TRESHOLD_ABILITY, MAGIC_PATH+"/wild_magic.png", ActionStyle.MAGIC),
    ASPHYXIATE("Asphyxiate", NativeKeyEvent.VC_W, true, false, false,
            ActionTier.TRESHOLD_ABILITY, MAGIC_PATH+"/asphyxiate.png", ActionStyle.MAGIC),
    DETONATE("Detonate", NativeKeyEvent.VC_E, true, false, false,
            ActionTier.TRESHOLD_ABILITY, MAGIC_PATH+"/detonate.png", ActionStyle.MAGIC),
    METAMORPHOSIS("Metamorphosis", NativeKeyEvent.VC_F, true, false, false,
            ActionTier.ULTIMATE_ABILITY, MAGIC_PATH+"/metamorphosis.png", ActionStyle.MAGIC),
    CORRUPTION_BLAST("Corruption Blast", NativeKeyEvent.VC_A, true, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/corruption_blast.png", ActionStyle.MAGIC),
    COMBUST("Combust", NativeKeyEvent.VC_R, true, false, false,
            ActionTier.BASIC_ABILITY, MAGIC_PATH+"/combust.png", ActionStyle.MAGIC),
    SMOKE_TENDRILS("Smoke Tendrils", NativeKeyEvent.VC_R, false, false, false,
            ActionTier.TRESHOLD_ABILITY, MAGIC_PATH+"/smoke_tendrils.png", ActionStyle.MAGIC),
